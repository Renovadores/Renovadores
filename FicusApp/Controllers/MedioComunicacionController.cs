...
namespace FicusApp.Controllers
{
    ...
    public class MedioComunicacionController : ControllerBase
    {
        ...
        {
            if (id != medioComunicacion.id_medio)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<MedioComunicacion>> PostMedioComunicacion(MedioComunicacion medioComunicacion)
        {
          if (_context.MedioComunicacion == null)
          {
            ...
            {
                if (MedioComunicacionExists(medioComunicacion.id_medio))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetMedioComunicacion", new { id = medioComunicacion.id_medio }, medioComunicacion);
        }
        ...
        {
            return (_context.MedioComunicacion?.Any(e => e.id_medio == id)).GetValueOrDefault();
        }
    }
}
