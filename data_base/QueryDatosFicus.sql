...
VALUES
  ('EC-07-1-JA','Montezuma', 1,'Sopa pequeña', 1, 1,'12 oz (4,25"" Top Dia., 2,75"" Tall)', NULL, NULL, NULL,130,170, 0, 300, 50, 250, 0),
  ('EC-08-1-JA','Ena', 3,'Sin compartimientos pequeño', 2, 1,'05,00""L-05,00""W-03,25""H', NULL, NULL, NULL,110,150, 0, 100, 50, 50, 0),
  ('EC-10-1-JA','Dota', 2,'Sin compartimientos tapa regular', 2, 1,'09,00""L-09,00""W-03,50""H', NULL, NULL, NULL,290,330, 0, 90, 90, 0, 0),
  ('EC-11-1-CL','Urán', 3,'Medio tamaño', 3, 2,'09,00""L-06,50""W-02,75""H', NULL, Null, NULL,185,225, 0, 230, 100, 130, 0),
  ('EC-11-1-JA','Urán', 3,'Medio tamaño', 3, 1,'09,00""L-06,50""W-02,75""H', NULL, NULL, NULL,185,2250, 0, 70, 50, 20, 0),
  ('EC-12-1-CL','Tapantí', 2,'3 compartimientos tapa regular', 4, 2,'09,00""L-09,00""W-02,50""H', NULL, NULL, NULL,235,280, 0, 100, 50, 50, 0),
  ('EC-12-1-JA','Tapantí', 2,'3 compartimientos tapa regular', 4,1,'09,00""L-09,00""W-02,50""H', NULL, NULL, NULL,235,280, 0, 100, 100, 0, 0),
  ('EC-13-1-JA','Sirena', 1,'Sopa regular', 1, 1,'16 oz (4,25"" Top Dia., 3,75"" Tall)', NULL, NULL, NULL,150,190, 0, 100, 100, 0, 0),
  ('EC-15-2-JA','Monteverde', 2,'2 compartimientos tapa regular', 4, 1,'10,00""L-08,00""W-03,00""H', NULL, NULL, NULL,235,280, 0, 100, 50, 40, 10),
  ('EC-17-JA','Corcovado', 2,'Sin compartimientos tapa plana', 2, 1,'09,00""L-09,00""W-02,00""H', NULL, NULL, NULL,290,330, 0, 58, 50, 8, 0),
  ('EC-18-JA','Kamúk', 3,'Medio tamaño tapa plana', 3, 1,'09,00""L-06,50""W-02,00""H', NULL, NULL, NULL,185,225, 0, 200, 100, 100, 0),
  ('EC-19-CL','Chirripó', 3,'Medio tamaño pequeño', 3, 2,'08,00""L-05,50""W-02,75""H', NULL, NULL, NULL,160,200, 0, 75, 0, 75, 0),
  ('EC-19-JA','Chirripó', 3,'Medio tamaño pequeño', 3, 1,'08,00""L-05,50""W-02,75""H', NULL, NULL, NULL,160,200, 0, 100, 50, 50, 0),
  ('EC-23-1-JA','Chiquita', 1,'Bowl pequeño', 1, 1,'12 oz (4,375"" Top Dia., 2,3"" Tall)', NULL, NULL, NULL,130,170, 0, 100, 50, 0, 50),
  ('EC-24-1-JA','Coco', 1,'Bowl regular', 1, 1,'16 oz (4,375"" Top Dia., 2,9"" Tall)', NULL,51, NULL,150,190, 0, 100, 100, 0, 0),
  ...
  ('M-273-MO',NULL,4,'Plato redondo principal', 6, 6,'23,50 cm Dia - 02,00 cm H', NULL,79.25,14,80.51,115, 0, 200, 100, 100, 0),
  ('M-273-RO',NULL,4,'Plato redondo principal', 6, 5,'23,50 cm Dia - 02,00 cm H', NULL,81.65,14,80.51,115, 0, 300, 70, 230, 0),
